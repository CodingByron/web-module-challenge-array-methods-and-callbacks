...
function getWinners(data, getFinalsCallBack) {
    return getFinalsCallBack(data).map(item => item["Home Team Goals"] > item["Away Team Goals"] ? item["Home Team Name"] : item["Away Team Name"]);
}
...
function getWinnersByYear(data, getFinalsCallBack, getYearsCallBack, getWinnersCallBack) {
    const winners = getWinnersCallBack(data, getFinalsCallBack);
    const years = getYearsCallBack(data, getFinalsCallBack);
